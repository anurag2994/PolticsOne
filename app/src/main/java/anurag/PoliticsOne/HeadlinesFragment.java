...
public class HeadlinesFragment extends ListFragment implements
    ...
    public static final String PARSED_FEED_DATA = "anurag.PoliticsOne.parsedfeeddata";
    public static final String ARTICLE_ID = "anurag.PoliticsOne.articleid";
    public static final String TASK_FRAGMENT = "anurag.PoliticsOne.taskfragment";
    public static final String RESTORED_DATA_FROM_DB = "anurag.PoliticsOne.restoreddata";
    public static final String SYNCING = "anurag.PoliticsOne.syncing";
