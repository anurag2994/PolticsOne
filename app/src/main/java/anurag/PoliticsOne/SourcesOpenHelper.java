...
public class SourcesOpenHelper extends SQLiteOpenHelper {
    ...
    public SourcesOpenHelper(Context context) {
        ...
        clearAllSources();
        //addSource("http://feeds.feedburner.com/SrnNewsPolitics", 1);
        addSource("http://timesofindia.indiatimes.com/rssfeedstopstories.cms", 1);
        //addSource("http://www.ddinews.gov.in/rssNews/Pages/rssnews.aspx", 1);
