...
public class ModifySources extends ListActivity implements ModifySourceDialogFragment.ModifySourceCallbacks, AddSourceDialogFragment.AddSourceCallbacks{
    ...
    private static final String TAG_SOURCES = "anurag.PoliticsOne.sources";
    private static final String TAG_MODIFY_SOURCE_DIALOG_FRAGMENT = "anurag.PoliticsOne.modifysourcedialogfragment";
    private static final String TAG_ADD_SOURCE_DIALOG_FRAGMENT = "anurag.PoliticsOne.addsourcedialogfragment";
    ...
    public boolean onMenuItemSelected (int featureId, MenuItem item) {
        ...
        if (id == R.id.action_new) {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                ...
                File path = new File(sdCard.getAbsolutePath() + "/anurag.PoliticsOn.rssfeedreader/feeds");
                path.mkdirs();
                File file = new File(path, "feeds-export.txt");
                try {
                    BufferedWriter writer = new BufferedWriter(new FileWriter(file));
                    String[] sources = new SourcesOpenHelper(this).getSources();
                    writer.write("anurag.PoliticsOn.rssfeedreader.export\n");
        ...
        if (requestCode == TAG_IMPORT_FILE_RESULT_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                try {
                    ...
                    if (line != null && line.equals("anurag.PoliticsOn.rssfeedreader.export")) {
                        SourcesOpenHelper dbHelper = new SourcesOpenHelper(this);
